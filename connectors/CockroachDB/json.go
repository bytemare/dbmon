...
// CockroachJson interface statically links a JSON struct to its resource/URI
type CockroachJson interface {
	resource() string
}

type CockroachProbe struct {
	health         *Health
	healthReady    *HealthReady
	singleNode     *SingleNode
	allNodes       *AllNodes
	singleHotrange *SingleHotrange
	allHotRanges   *AllHotRanges
	clusterRaft    *ClusterRaft
	clusterRange   *ClusterRange
}

/*
Registered requests that return following json objects
*/
...
func (h *HealthReady) resource() string {
	return reqHealthReady
}
...
type SingleNode struct {
	...
	Metrics   struct {
		...
		ChangefeedMinHighWater                   int64   `json:"changefeed.min_high_water"`
		...
		SysGcPausePercent                        int     `json:"sys.gc.pause.percent"`
...
func (h *SingleNode) resource() string {
	return reqSingleNode
}
...
func (h *AllNodes) resource() string {
	return reqAllNodes
}

// SingleHotange
// _status/hotranges?node_id=[node_id]
type SingleHotrange struct {
	NodeID            int `json:"nodeId"`
	HotRangesByNodeID struct {
		Num1 struct {
	...
	} `json:"hotRangesByNodeId"`
}

func (h *SingleHotrange) resource() string {
	return reqSingleHotrange
}

// AllHotranges
// /_status/hotranges
// TODO : This is very temporary, as the structure is the same as the single and suited to a 3-node cluster
type AllHotRanges struct {
	NodeID            int `json:"nodeId"`
	HotRangesByNodeID struct {
		Num1 struct {
			ErrorMessage string `json:"errorMessage"`
...
func (h *AllHotRanges) resource() string {
	return reqAllHotRanges
}
...
func (h *ClusterRaft) resource() string {
	return reqClusterRaft
}
...
type ClusterRange struct {
	...
	} `json:"responsesByNodeId"`
}

func (h *ClusterRange) resource() string {
	return reqClusterRange
}

// Error is returned, well, on error
type Error struct {
